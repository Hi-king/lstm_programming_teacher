...
for epoch in range(args.epoch):
    train(positive_train, negative_train, predictor, optimizer, batch=1)
    test(positive_train, negative_train, predictor)
